...
<head>
  ...
  <title>Web site -  Personal Portfolio | Login </title>
              ...
              <div class="card content-box-card">
                <div class="card-body portfolio-card contact-card">
                  <div class="top-info">
                    ...
                    <br>
                    <div class="text">
                      <h1 class="main-title">Login 👋 <span>Today!</span> </h1>
                      <p>Set up your dashbaord...</p>
                    </div>
                  </div>
                      ...
                      <div class="comments-box">
                        <form   method="POST">
                          <div class="row gx-3">
                            ...
                            <div class="col-md-12">
                              <button class="submit-btn" name="auth_user" type="submit">
                                Create Account
                              ...
                              <a href="register.php">Not yet a member? Register instead!</a>
                            </div>
                            <?php
                                  if(isset($_POST["auth_user"])){
                                      ...
                                      $password = $_POST["password"];
                                        ...
                                        $fields = ($email !== "" && $password !== "" ) ? true : false;
                                        ...
                                        if($fields){ // check for empty fields
                                            ...
                                            if(authenticateUser($email,$password)){
                                                ...
                                                echo "Unable to authenticate, please try again!";
                                            }
                                    }else{
