...
<head>
    ...
    <title>Dashbaod - Languages</title>
</head>
<body class="bg-eee">
    <div class="page d-flex bg-eee">
        ...
        <div class="content w-full">
            ...
            <!-- End Content Head -->
            <h1 class="p-relative">Languages</h1>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-15">
                                        <label for="logo" class="fs-14 c-grey mb-5 d-block"> Language Logo </label>
            ...
            <?php
                ...
                $language_list = getAllLanguage($admin_id); 
            ...
            ?>
                ...
                <div class="friend p-20 rad-6 bg-white p-relative">    
                    <div class="foot between-flex gap-10 flex-column-mobile">
                        ...
                        <span class="c-grey fs-13 fw-500"><img src="../includes/uploads/<?php echo $language_list[$languages][3]; ?>" class="mb-10"></span>
                        <span class="c-grey fs-13 fw-500"><?php echo $language_list[$languages][4]; ?></span>
                        <div>
