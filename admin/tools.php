        ...
        <div class="content w-full">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-15">
                                        ...
                                        <div class="d-flex gap-10 align-center">
                                            <input type="text" placeholder="eg: john" required name="description" class="w-full p-10 b-none border-ccc rad-6 " id="description" >
                                        
                                        </div>
                                </div>
                                <div class="mb-15">
                                        <label for="logo" class="fs-14 c-grey mb-5 d-block"> Tool Logo </label>
                                ...
                                <div class="mb-15">
                                    ...
                                    <div class="mb-15">
                                        <button type="submit" style="padding: 10px;width: 100px;" name="change" class="bg-red btn-shape fs-14 c-white b-none d-line my-pointer ">Save change</button>
                                    </div>
                                    ...
                                    <?php 
                                        if(isset($_POST["save"])){
                                                ...
                                                $toolsLogo = uploasFiles ("logo");

                                                $_POST["picture_url"] = ($toolsLogo[0] == true ) ? $toolsLogo[1] : "";


                                                $fields = ($title !== "" && $rate !== ""  && $description !== "" ) ? true : false;
            ...
            <?php
                ...
                <div class="friend p-20 rad-6 bg-white p-relative">    
                    <div class="foot between-flex gap-10 flex-column-mobile">
                        <span class="c-grey fs-13 fw-500"><?php echo $tool_List[$tools][2]; ?></span>
                        <span class="c-grey fs-13 fw-500"><?php echo $tool_List[$tools][3]; ?></span>
                        <span class="c-grey fs-13 fw-500"><img src="../includes/uploads/<?php echo $tool_List[$tools][4]; ?>" class="mb-10"></span>
                        <span class="c-grey fs-13 fw-500"><?php echo $tool_List[$tools][5]; ?></span>
                        <div>
                            <a href="delete.php?id=<?php echo $tool_List[$tools][0] ?>" class="btn-shape bg-red c-white fs-13">remove</a>
                        </div>
                    </div>
                </div>
