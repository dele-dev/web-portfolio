...
<head>
    ...
    <title>Dashbaod - FrameWorks</title>
</head>
<body class="bg-eee">
    <div class="page d-flex bg-eee">
        ...
        <div class="content w-full">
            ...
            <!-- End Content Head -->
            <h1 class="p-relative">FrameWorks</h1>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <div class="mb-15">
                                        <label for="logo" class="fs-14 c-grey mb-5 d-block"> Frame Work Logo </label>
                                ...
                                <div class="mb-15">
                                    ...
                                    <?php 
                                            if(isset($_POST["save"])){
                                                    ...
                                                    $languageLogo = uploasFiles ("logo");

                                                    $_POST["picture_url"] = ($languageLogo[0] == true ) ? $languageLogo[1] : "";
                                                    ...
                                                    if($fields){ // check for empty fields
                                                        ...
                                                        if(saveFrameWork($_POST)){
                                                            echo "New Language Saved!";
                                                        }else{
            ...
            <?php
                ...
                $language_list = getAllFrameWork($admin_id); 
            ...
            ?>
                ...
                <div class="friend p-20 rad-6 bg-white p-relative">    
                    <div class="foot between-flex gap-10 flex-column-mobile">
                        <span class="c-grey fs-13 fw-500"><?php echo $language_list[$languages][2]; ?></span>
                        <span class="c-grey fs-13 fw-500"><?php echo $language_list[$languages][3]; ?></span>
                        <span class="c-grey fs-13 fw-500"><img src="../includes/uploads/<?php echo $language_list[$languages][4]; ?>" class="mb-10"></span>
                        <span class="c-grey fs-13 fw-500"><?php echo $language_list[$languages][5]; ?></span>
                        <div>
                            <a href="delete.php?id=<?php echo $language_list[$languages][0] ?>" class="btn-shape bg-red c-white fs-13">remove</a>
                        </div>
                    </div>
                </div>
