    ...
    <div class="page d-flex bg-eee">
        ...
        <div class="content w-full">
            ...
            <form action="" method="post">
                                ...
                                <div class="mb-15">
                                        <label for="from" class="fs-14 c-grey mb-5 d-block">Question</label>
                                ...
                                <div class="mb-15">
                                        <label for="Description" class="fs-14 c-grey mb-5 d-block"> Detailed Answers </label>
            ...
            <div class="friends-page wrapper pb-20 m-20 d-grid gap-20">
                    ...
                    <div class="friend p-20 rad-6 bg-white p-relative">    
                        <div class="foot between-flex gap-10 flex-column-mobile">
                            <span class="c-grey fs-13 fw-500"><?php echo $faq_list[$faqs][2]; ?></span>
                            <span class="c-grey fs-13 fw-500"> <?php echo $faq_list[$faqs][3];  ?></span>
                            <div>
                                <a href="delete.php?id=<?php echo $faq_list[$faqs][0] ?>" class="btn-shape bg-red c-white fs-13">remove</a>
                            </div>
                        </div>
                    </div>
