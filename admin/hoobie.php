...
<body class="bg-eee">
    <div class="page d-flex bg-eee">
        ...
        <div class="content w-full">
            ...
            <!-- End Content Head -->
            <h1 class="p-relative">Hoobies</h1>
            ...
            <div class="friends-page wrapper pb-20 m-20 d-grid gap-20">
                    ...
                    $hoobie_list = getAllHoobie($admin_id); 

                    foreach ($hoobie_list as $hoobies => $value){

                    ?>

                    <div class="friend p-20 rad-6 bg-white p-relative">    
                        <div class="foot between-flex gap-10 flex-column-mobile">
                            <span class="c-grey fs-13 fw-500"><?php echo $hoobie_list[$hoobies][2]; ?></span>
                            <span class="c-grey fs-13 fw-500"> <?php echo $hoobie_list[$hoobies][3];  ?></span>
                            <div>
                                <a href="delete.php?id=<?php echo $hoobie_list[$hoobies][0] ?>" class="btn-shape bg-red c-white fs-13">remove</a>
                            </div>
                        </div>
                    </div>
