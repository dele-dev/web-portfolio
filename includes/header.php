<?php
                                $bio_Link =  getAllBio($user_profile);
                                $contact_List = getAllFeedback($user_profile); 

                                $page_url = explode("/",$_SERVER['REQUEST_URI']) ;// getting current page
          ...
          <div class="menu-container">
            <div class="logo">
              <a class="navbar-brand me-0" href="index.php">
                ...
                <span><?php echo $bio_Link[0][1] ."'s " ?> <span class="primary">Views</span></span>
              </a>
            </div>
            <div class="navbar-main d-flex flex-grow-1">
              ...
              <ul class="navbar-info mx-auto">
                <li class="nav-item">
                  <a class="nav-link  <?php echo (($page_url[count($page_url) - 1]) == "index.php") ? 'active' : '' ?>" aria-current="page" href="index.php">
                ...
                <li class="nav-item">
                  <a class="nav-link <?php echo (($page_url[count($page_url) - 1]) == "about.php") ? 'active' : '' ?>" href="about.php">
                ...
                <li class="nav-item">
                  <a class="nav-link <?php echo (($page_url[count($page_url) - 1]) == "services.php") ? 'active' : '' ?>" href="services.php">
                ...
                <li class="nav-item">
                  <a class="nav-link <?php echo (($page_url[count($page_url) - 1]) == "portfolio.php") ? 'active' : '' ?>"  href="portfolio.php">
