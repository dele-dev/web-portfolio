...
<div class="card profile-card">
                <div class="card-body">
                  <div class="image text-center">
                    <img src="./includes/uploads/<?php echo $bio_Link[0][4]; ?>" alt="profile">
                  </div>
                  <div class="text">
                    <h3 class="card-title"><?php echo $bio_Link[0][1] ." ".$bio_Link[0][2] ; ?> 👋</h3>
                    <p><?php echo $bio_Link[0][5]; ?></p>
                    <div class="common-button-groups">
                      <a class="btn btn-call" href="tel:<?php echo  $contact_List[1][3]; ?>">
                      ...
                      <button class="btn btn-copy" data-clipboard-text="<?php echo  $contact_List[2][3]; ?>">
                    ...
                    <div class="social-media-icon">
                      <ul class="list-unstyled">
                        ...
                        <li><a href="index.php#"><i class="fab fa-github"></i></a></li>
